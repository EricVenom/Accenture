...
public class Tabuleiro {
	...
	public void encerrarJogo(boolean resultado) {
		if (resultado) {
			this.jogoAtivo = false;
			JOptionPane.showMessageDialog(null, "Vitória do Jogador " + this.vencedor + "!", "Fim de Jogo!", JOptionPane.INFORMATION_MESSAGE);
		}
	}
	...
	public void fazerJogada(int jogador, int linha, int coluna) {
		...
		if (this.matrizTabuleiro[linha][coluna].equals(" ")) {			
			...
			JOptionPane.showMessageDialog(null, "Jogador " + jogador + 
					" perdeu a vez por escolher uma posição já ocupada!", "OPA!", JOptionPane.WARNING_MESSAGE);
		}
	}
